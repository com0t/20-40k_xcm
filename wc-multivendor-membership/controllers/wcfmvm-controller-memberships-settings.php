...
class WCFMvm_Memberships_Settings_Controller {
	...
	public function processing() {
	  ...
	  $wcfm_membership_settings_form_data = wc_clean( $wcfm_membership_settings_form_data );
	  
	  if( !defined('WCFM_REST_API_CALL') ) {
	  	if( isset( $wcfm_membership_settings_form_data['wcfm_nonce'] ) && !empty( $wcfm_membership_settings_form_data['wcfm_nonce'] ) ) {
	  		if( !wp_verify_nonce( $wcfm_membership_settings_form_data['wcfm_nonce'], 'wcfm_membership_settings' ) ) {
	  ...
	  if( isset( $_POST['free_thankyou_content'] ) ) {
	  	wcfm_update_option( 'wcfm_membership_free_thankyou_content', wp_filter_post_kses( stripslashes( html_entity_decode( $_POST['free_thankyou_content'], ENT_QUOTES, 'UTF-8' ) ) ) );
	  }
	  
	  if( isset( $_POST['subscription_thankyou_content'] ) ) {
	  	wcfm_update_option( 'wcfm_membership_subscription_thankyou_content', wp_filter_post_kses( stripslashes( html_entity_decode( $_POST['subscription_thankyou_content'], ENT_QUOTES, 'UTF-8' ) ) ) );
	  }
	  ...
	  if( isset( $_POST['non_membership_welcome_email_content'] ) ) {
	  	wcfm_update_option( 'wcfm_non_membership_welcome_email_content', wp_filter_post_kses( stripslashes( html_entity_decode( $_POST['non_membership_welcome_email_content'], ENT_QUOTES, 'UTF-8' ) ) ) );
	  }
	  ...
	  if( isset( $_POST['subscription_welcome_email_content'] ) ) {
	  	wcfm_update_option( 'wcfm_membership_subscription_welcome_email_content', wp_filter_post_kses( stripslashes( html_entity_decode( $_POST['subscription_welcome_email_content'], ENT_QUOTES, 'UTF-8' ) ) ) );
	  }
	  ...
	  if( isset( $_POST['registration_admin_notication_content'] ) ) {
	  	wcfm_update_option( 'wcfm_registration_admin_notication_content', wp_filter_post_kses( stripslashes( html_entity_decode( $_POST['registration_admin_notication_content'], ENT_QUOTES, 'UTF-8' ) ) ) );
	  }
	  ...
	  if( isset( $_POST['subscription_admin_notication_content'] ) ) {
	  	wcfm_update_option( 'wcfm_membership_subscription_admin_notication_content', wp_filter_post_kses( stripslashes( html_entity_decode( $_POST['subscription_admin_notication_content'], ENT_QUOTES, 'UTF-8' ) ) ) );
	  }
	  ...
	  if( isset( $_POST['onapproval_admin_notication_content'] ) ) {
	  	wcfm_update_option( 'wcfm_membership_onapproval_admin_notication_content', wp_filter_post_kses( stripslashes( html_entity_decode( $_POST['onapproval_admin_notication_content'], ENT_QUOTES, 'UTF-8' ) ) ) );
	  }
	  ...
	  if( isset( $_POST['switch_admin_notication_content'] ) ) {
	  	wcfm_update_option( 'wcfm_membership_switch_admin_notication_content', wp_filter_post_kses( stripslashes( html_entity_decode( $_POST['switch_admin_notication_content'], ENT_QUOTES, 'UTF-8' ) ) ) );
	  }
	  ...
	  if( isset( $_POST['switch_notication_content'] ) ) {
	  	wcfm_update_option( 'wcfm_membership_switch_notication_content', wp_filter_post_kses( stripslashes( html_entity_decode( $_POST['switch_notication_content'], ENT_QUOTES, 'UTF-8' ) ) ) );
	  }
	  ...
	  if( isset( $_POST['next_payment_notication_content'] ) ) {
	  	wcfm_update_option( 'wcfm_membership_next_payment_notication_content', wp_filter_post_kses( stripslashes( html_entity_decode( $_POST['next_payment_notication_content'], ENT_QUOTES, 'UTF-8' ) ) ) );
	  }
	  ...
	  if( isset( $_POST['reminder_notication_content'] ) ) {
	  	wcfm_update_option( 'wcfm_membership_reminder_notication_content', wp_filter_post_kses( stripslashes( html_entity_decode( $_POST['reminder_notication_content'], ENT_QUOTES, 'UTF-8' ) ) ) );
	  }
	  ...
	  if( isset( $_POST['reject_notication_content'] ) ) {
	  	wcfm_update_option( 'wcfm_membership_reject_notication_content', wp_filter_post_kses( stripslashes( html_entity_decode( $_POST['reject_notication_content'], ENT_QUOTES, 'UTF-8' ) ) ) );
	  }
	  ...
	  if( isset( $_POST['cancel_notication_content'] ) ) {
	  	wcfm_update_option( 'wcfm_membership_cancel_notication_content', wp_filter_post_kses( stripslashes( html_entity_decode( $_POST['cancel_notication_content'], ENT_QUOTES, 'UTF-8' ) ) ) );
	  }
	  ...
	  if( isset( $_POST['expire_notication_content'] ) ) {
	  	wcfm_update_option( 'wcfm_membership_expire_notication_content', wp_filter_post_kses( stripslashes( html_entity_decode( $_POST['expire_notication_content'], ENT_QUOTES, 'UTF-8' ) ) ) );
	  }
