...
class WCFMvm_Shortcode {
	...
	public function wcfmvm_subscribe( $attr ) {
		...
		<div class="wcfm_ele_wrapper wcfm_membership_subscribe_button_wrapper">
		  <input class="wcfm_membership_subscribe_button wcfm_submit_button button" type="button" data-membership="<?php echo esc_attr($membership_id); ?>" style="<?php echo $style; ?>" value="<?php _e( $subscribe_now_label, 'wc-multivendor-membership' ); ?>">
		</div>
		<?php
		return ob_get_clean();
	}
